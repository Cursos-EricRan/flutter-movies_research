...
//
//     final movieDetailResponse = movieDetailResponseFromMap(jsonString);
...
class MovieDetailResponse {
  ...
  factory MovieDetailResponse.fromJson(String str) =>
      MovieDetailResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory MovieDetailResponse.fromMap(Map<String, dynamic> json) =>
      MovieDetailResponse(
        adult: json["adult"],
